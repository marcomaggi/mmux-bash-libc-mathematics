...
function format-f-1.1 () {
    mmux-bash-libc-mathematics-double-format "%f"
    dotest-equal 1.000000 $(add '1')
}
function format-f-1.2 () {
    mmux-bash-libc-mathematics-double-format "%lf"
    dotest-equal 1.000000 $(add '1')
}
...
function format-f-2.1 () {
    mmux-bash-libc-mathematics-double-format "%.1f"
...
function format-f-2.3 () {
    mmux-bash-libc-mathematics-double-format "%.3f"
...
function format-f-3.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%20f"
...
function format-f-3.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%5.0f"
...
function format-f-3.3 () {
    ...
    mmux-bash-libc-mathematics-double-format "%6.0f"
    printf -v RESULT '{%s}' "$(add '12345')"
    dotest-equal '{ 12345}' QQ(RESULT)
}
...
function format-f-6.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%013.0f"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-f-8.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-13.0f"
    printf -v RESULT '{%s}' "$(add '123456789')"
    dotest-equal '{123456789    }' QQ(RESULT)
}
...
function format-g-1.1 () {
    mmux-bash-libc-mathematics-double-format "%g"
    dotest-equal 1 $(add '1')
}
function format-g-1.2 () {
    mmux-bash-libc-mathematics-double-format "%lg"
    dotest-equal 1 $(add '1')
}
...
function format-g-3.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%20g"
    printf -v RESULT '{%s}' "$(add '123456789.0987654321')"
...
function format-g-3.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%5.0g"
    printf -v RESULT '{%s}' "$(add '12345')"
...
function format-g-3.3 () {
    ...
    mmux-bash-libc-mathematics-double-format "%6.0g"
    printf -v RESULT '{%s}' "$(add '12345')"
    dotest-equal '{ 1e+04}' QQ(RESULT)
    #              012345
}
...
function format-g-4.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%#.0g"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-g-5.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%'.8g"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-g-6.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%013.4g"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-g-6.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-013.3g"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-g-8.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-13.0g"
    printf -v RESULT '{%s}' "$(add '123456789')"
    dotest-equal '{1e+08        }' QQ(RESULT)
    #              0123456789012
}
...
function format-e-1.1 () {
    mmux-bash-libc-mathematics-double-format "%e"
    dotest-equal 1.000000e+00 $(add '1')
}
function format-e-1.2 () {
    mmux-bash-libc-mathematics-double-format "%le"
    dotest-equal 1.000000e+00 $(add '1')
}
...
function format-e-2.1 () {
    mmux-bash-libc-mathematics-double-format "%.1e"
    dotest-equal '1.2e+08' $(add '123456789.0987654321')
}
function format-e-2.2 () {
    mmux-bash-libc-mathematics-double-format "%.2e"
    dotest-equal '1.23e+08' $(add '123456789.0987654321')
}
function format-e-2.3 () {
    mmux-bash-libc-mathematics-double-format "%.3e"
    dotest-equal '1.235e+08' $(add '123456789.0987654321')
}
function format-e-2.4 () {
    mmux-bash-libc-mathematics-double-format "%.4e"
...
function format-e-3.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%20e"
    printf -v RESULT '{%s}' "$(add '123456789.0987654321')"
...
function format-e-3.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%5.0e"
    printf -v RESULT '{%s}' "$(add '12345')"
    dotest-equal '{1e+04}' QQ(RESULT)
    #              01234
}
function format-e-3.3 () {
    ...
    mmux-bash-libc-mathematics-double-format "%6.0e"
    printf -v RESULT '{%s}' "$(add '12345')"
    dotest-equal '{ 1e+04}' QQ(RESULT)
    #              012345
}
...
function format-e-4.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%#.0e"
    printf -v RESULT '{%s}' "$(add '123456789')"
    dotest-equal '{1.e+08}' QQ(RESULT)
}
...
function format-e-5.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%'.8e"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-e-6.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%013.4e"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-e-6.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-013.3e"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-e-8.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-13.0e"
    printf -v RESULT '{%s}' "$(add '123456789')"
    dotest-equal '{1e+08        }' QQ(RESULT)
    #              0123456789012
}
...
function format-a-1.1 () {
    mmux-bash-libc-mathematics-double-format "%a"
    dotest-equal '0x1p+0' $(add '1')
}
function format-a-1.2 () {
    mmux-bash-libc-mathematics-double-format "%la"
    dotest-equal '0x1p+0' $(add '1')
}
...
function format-a-3.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%30a"
    printf -v RESULT '{%s}' "$(add '123456789.0987654321')"
...
function format-a-3.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%4.0a"
    printf -v RESULT '{%s}' "$(add '12345')"
...
function format-a-3.3 () {
    ...
    mmux-bash-libc-mathematics-double-format "%10.0a"
    printf -v RESULT '{%s}' "$(add '12345')"
    dotest-equal '{   0x2p+13}' QQ(RESULT)
    #              0123456789
}
...
function format-a-4.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%#.0a"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-a-5.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%'.8a"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-a-6.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%020.4a"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-a-6.2 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-020.3a"
    printf -v RESULT '{%s}' "$(add '123456789')"
...
function format-a-8.1 () {
    ...
    mmux-bash-libc-mathematics-double-format "%-13.0a"
    printf -v RESULT '{%s}' "$(add '123456789')"
    dotest-equal '{0x2p+26      }' QQ(RESULT)
    #              0123456789012
}
